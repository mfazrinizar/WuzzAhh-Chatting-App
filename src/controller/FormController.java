 ...
 */
 ...
 public class FormController {
     ...
     public boolean registerUser(String name, String username, String password, String confirmPassword) throws SQLException {
         ...
         if (!FormValidator.isValidUsername(username)) {
             throw new IllegalArgumentException("Invalid username (6 characters).");
         }
